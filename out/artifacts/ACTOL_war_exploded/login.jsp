...
<div class="col-md-3" id="login">
    ...
    <div class="col-md-12 denglu" id="dlqian">
        <div class="dl">
            ...
            <input id="user" type="text" name="loginnname" value="输入用户名/注册邮箱/手机号">
        </div>
        <div class="dl">

            <input id="pass" type="text" name="pword" value="输入登录密码">
        </div>
        <div class="foget">
            <a href="忘记密码.html" target="_blank" >忘记密码</a>
        </div>
        <div class="dlbutton">
            <button class="btn btn-primary btn-lg" id="dlbtn" type="submit" >登录</button>
